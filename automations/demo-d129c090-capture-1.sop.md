...
**Capture version:** 1  
**Generated:** 2026-07-21T00:43:04.931Z  
**Recorded steps:** 46  
**Replay readiness:** Capture reviewed for known selector risks; a visible rehearsal is still required before background use.

## Purpose and scope
Repeat “Demo ” using 46 observed browser actions while preserving the exact capture and its review checkpoints.
...
await page.locator('#sa_ul').click();

```

### Step 05 — click

**Captured action:** Click link “Final · World Cup coverage”

**Operating rule:** Use the captured named control. If the control is missing, renamed, or behaves differently, stop and re-record instead of guessing.

**Required wait:** Wait 1 seconds after this action before the next captured step.

**Captured evidence:**

```playwright

await page.getByRole('link', { name: 'Final · World Cup coverage' }).click();

```

### Step 06 — click

**Captured action:** Click tab “Timeline”
...
await page.getByRole('tab', { name: 'Timeline' }).press('ArrowDown');
