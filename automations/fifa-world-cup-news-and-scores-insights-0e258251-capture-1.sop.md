# FIFA World Cup news and scores insights — SOP & Rule Book
...
## Purpose and scope
Repeat “FIFA World Cup news and scores insights” using 1 observed browser action while preserving the exact capture and its review checkpoints.
...
**Captured action:** Open https://www.bing.com/search?q=FIFA+World+Cup+news+and+scores
