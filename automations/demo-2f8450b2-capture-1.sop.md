...
**Capture version:** 1  
**Generated:** 2026-07-21T00:38:35.550Z  
**Recorded steps:** 47  
**Replay readiness:** Capture reviewed for known selector risks; a visible rehearsal is still required before background use.

## Purpose and scope
Repeat “Demo ” using 47 observed browser actions while preserving the exact capture and its review checkpoints.
...
**Required wait:** Wait 0.5 seconds after this action before the next captured step.
