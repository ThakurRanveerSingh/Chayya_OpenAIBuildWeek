...
**Capture version:** 1  
**Generated:** 2026-07-21T00:29:53.789Z  
**Recorded steps:** 55  
**Replay readiness:** Capture reviewed for known selector risks; a visible rehearsal is still required before background use.

## Purpose and scope
Repeat “demo” using 55 observed browser actions while preserving the exact capture and its review checkpoints.
...
await page.getByRole('tab', { name: 'Lineups' }).press('ArrowLeft');
